    ...
    static Screen generate(Screen parent) {
        ...
        builder.getOrCreateCategory(translatableSelf("config.qol"))
                .addEntry(builder.entryBuilder().startBooleanToggle(translatableSelf("config.qol.storagetargetingfix"), config.qol.storageTargetingFix)
                        ...
                        .build())
                .addEntry(builder.entryBuilder().startBooleanToggle(translatableSelf("config.qol.storageframesfix"), config.qol.storageFramesFix)
                        .setDefaultValue(Config.DEFAULT.qol.storageFramesFix)
                        .setSaveConsumer(value -> config.qol.storageFramesFix = value)
                        .build())
